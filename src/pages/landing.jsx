...
//         return <CarouselItem key={id} className="basis-1/3 lg:basis-1/6 "><img src={path} alt={name} className='h-9 sm:h-14 object-contain '/></CarouselItem>
//       })}
//       </CarouselContent>
...
const LandingPage = () => {
  return (
    <main className="flex flex-col gap-10 sm:gap-20 py-10 sm:py-20">
      ...
      >
        <CarouselContent className="flex gap-5 sm:gap-20 items-center px-6">
